...
public class dartLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"AS_", "ASSERT_", "ASYNC_", "AWAIT_", "ADD_", "BOXDECORATION_", "BOXSHAPE_", 
			...
			"QUEUE", "VARTYPE", "VOID_", "WHILE_", "WITH_", "WIDGET_", "YIELD_", 
			"Main", "INT", "BOOL", "PUBLIC_", "PROTECT_", "PRIVATE_", "Image_", "IMAGEIN_", 
			"NETWORKIMAGE_", "TEXTFORMFIELD_", "LABELTEXT_", "HINTTEXT_", "HOME", 
			"MATERIALAPP", "RUNAPP", "MYAPP", "HEIGHT_", "WIDTH_", "ROW_", "COLUMN_", 
			"CHILDREN", "MAINAXISALIGNMENT", "MAINAXISALIGNMENTIN", "CROSSAXISALIGNMENT", 
			"CROSSAXISALIGNMENTIN", "CENTER", "END", "START", "LISTVIEW_", "SCROLLDIRECTION", 
			"AXIS", "HORIZONTAL", "VERTICAL", "BUILDER", "ITEMBUILDER", "ITEMCOUNT", 
			"CONTEXT", "SCAFFOLD", "BODY", "TYPEWIDGET", "Navigator", "PUSH", "Pop", 
			"MaterialPageRoute", "Text", "OnPressed", "TextButton", "ACCESSMODIFIER", 
