// Generated from C:/Users/HP/Desktop/Intellij Projects/finalCompilerProject/src/antlr\dartLexer.g4 by ANTLR 4.10.1
package antlr;
...
public class dartLexer extends Lexer {
	...
	public static final int
		...
		WHITESPACE=206, SINGLE_LINE_COMMENT=207, MULTI_LINE_COMMENT=208;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"A", "AA", "AE", "AT", "Dollar", "C", "Dq", "Sq", "CB", "CBC", "CIR", 
			"CIRE", "CO", "CP", "D", "DD", "DDD", "EE", "EG", "EQ", "GT", "LT", "LTE", 
			"LTLT", "LTLTE", "ME", "MINUS", "MM", "NE", "NOT", "OB", "OBC", "OP", 
			"P", "PC", "PE", "PL", "PLE", "PLPL", "PO", "POE", "PP", "QU", "QUD", 
			"QUDD", "QUQU", "QUQUEQ", "ROW", "SC", "SE", "SL", "SQS", "SQSE", "SQUIG", 
			"ST", "STE", "ABSTRACT_", "AS_", "ASSERT_", "ASYNC_", "AWAIT_", "ADD_", 
			"BOXDECORATION_", "BORDERRADIUS_", "CIRCULAR_", "BOXSHAPE_", "BREAK_", 
			"CASE_", "CATCH_", "CLASS_", "CONST_", "CONTINUE_", "CONTROLLER_", "COVARIANT_", 
			"CONTAINER_", "CHILD_", "COLOR_", "COLORS_", "DEFAULT_", "DEFERRED_", 
			"DO_", "DYNAMIC_", "ELSE_", "ENUM_", "EXPORT_", "EXTENDS_", "EXTENSION_", 
			"EXTERNAL_", "FACTORY_", "FALSE_", "FINAL_", "FINALLY_", "FOR_", "FONTSIZE", 
			"TEXTALIGN_P", "TEXTALIGN", "FUNCTION_", "GET_", "GTILDE_", "HIDE_", 
			...
			"OBSCURETEXT_", "Decoration", "InputDecoration", "LABELTEXT_", "HINTTEXT_", 
